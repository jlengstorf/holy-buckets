...
// watch_time_minutes: 63941.0752
    const viewDurationDomain = d3.extent(rawData, ({ average_view_duration }) => average_view_duration);
...
.bucket-color{fill:#F2F0F1;}
.bucket-fill{fill:#D6A9B2;}
.star{fill:#EACF5D;}
.wing1{fill:#B2DFD6;}
.wing2{fill:#B2DFD6;stroke:#FFFFFF;stroke-miterlimit:10;}
.halo{fill:#F2DD83;}
.bucket-outline{fill:none;stroke:#000000;stroke-width:3;stroke-miterlimit:10;}
.handle{fill:none;stroke:#000000;stroke-width:3;stroke-linecap:round;stroke-miterlimit:10;}
</style>
